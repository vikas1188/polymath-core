...
// import "../../TransferManager/GeneralTransferManagerStorage.sol";
...
contract SignedTransferManager is TransferManager {
    ...
    */
    function checkSignatureIsInvalid(bytes memory _data) public view returns(bool){
    ...
    */
    function updateSigners(address[] memory _signers, bool[] memory _signersStats) public withPerm(ADMIN) {
