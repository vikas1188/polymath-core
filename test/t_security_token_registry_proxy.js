...
contract ("SecurityTokenRegistryProxy", accounts => {
    ...
    before(async() => {
        ...
        I_SecurityTokenRegistryProxy = await SecurityTokenRegistryProxy.new("1.0.0", I_SecurityTokenRegistry.address, bytesProxy, {from: account_polymath});  
    ...
    describe("Feed some data in storage", async() => {
        ...
        it("Verify the initialize data", async() => {
            console.log(await I_STRProxied.getUintValues.call(web3.utils.soliditySha3("expiryLimit")));
            console.log(await I_STRProxied.getUintValues.call(web3.utils.soliditySha3("tickerRegFee")));            
